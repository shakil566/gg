    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><?php echo app('translator')->get('english.DESIGNATION'); ?></h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('/dashboard/admin')); ?>"><?php echo app('translator')->get('english.DASHBOARD'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo app('translator')->get('english.DESIGNATION'); ?></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo app('translator')->get('english.DESIGNATION_DETAILS'); ?></h3>
                                <a href="<?php echo e(url('admin/designation/create')); ?>"
                                        ...
                                        <?php if(!empty($designationArr)): ?>
                                            ...
                                            <?php $__currentLoopData = $designationArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <?php echo e(Form::open(['url' => 'admin/designation/' . $value->id, 'id' => 'delete'])); ?>

                                                        <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                                        <a class='btn btn-primary btn-xs'
                                                            href="<?php echo e(URL::to('admin/designation/' . $value->id . '/edit')); ?>"
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\LaravelProjectDemoAdminLte\resources\views/admin/designation/index.blade.php ENDPATH**/ ?>