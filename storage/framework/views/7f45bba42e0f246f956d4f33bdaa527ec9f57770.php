    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#"> <i class="far fa-calendar-alt"></i> Today is <span
                    class="font-blue-madison"><?php echo date('l, d F Y'); ?></span></a>
        </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <?php endif; ?>
                <span
                    class="nav-username"><?php echo e(Auth::user()->first_name . ' ' . Auth::user()->last_name . ' (' . Auth::user()->UserGroup->info . ')'); ?>
...
<?php /**PATH F:\xampp\htdocs\LaravelProjectDemoAdminLte\resources\views/layouts/admin/navbar.blade.php ENDPATH**/ ?>