...
<head>
    ...
    <!-- MultiSelect STYLES -->
    <link rel="stylesheet" href="<?php echo e(asset('public/backend')); ?>/css/bootstrap-multiselect.css" type="text/css">
    ...
    <!-- fullCalendar -->
    <link rel="stylesheet" href="<?php echo e(asset('public/backend')); ?>/plugins/fullcalendar/main.css">
...
<body>
    ...
    <!-- MultiSelect SCRIPTS -->
    <script type="text/javascript" src="<?php echo e(asset('public/backend')); ?>/js/bootstrap-multiselect.js"></script>
    ...
    <script src="<?php echo e(asset('public/backend')); ?>/plugins/fullcalendar/main.js"></script>
    <!-- Bootstrap Switch -->
