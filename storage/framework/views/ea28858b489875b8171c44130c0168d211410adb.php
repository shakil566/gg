                    ...
                    <div class="col-md-8 margin-top-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo app('translator')->get('english.UPDATE_DEPARTMENT'); ?></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php echo e(Form::model($department, array('route' => array('department.update', $department->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'departmentUpdate'))); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_8\htdocs\test\resources\views/admin/department/edit.blade.php ENDPATH**/ ?>