                    ...
                    <div class="col-md-8 margin-top-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo app('translator')->get('english.CREATE_NEW_UNIT'); ?></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php echo e(Form::open(['role' => 'form', 'url' => 'admin/unit', 'class' => 'form-horizontal', 'id' => 'createunit', 'files' => true,])); ?>


                            <div class="card-body">
                                <div class="form-group">
                                    <label for="desigName"><?php echo app('translator')->get('english.TITLE'); ?><span class="text-danger"> *</span></label>
                                    <?php echo e(Form::text('title', Request::get('title'), ['id' => 'title', 'class' => 'form-control', 'placeholder' => 'Enter unit Title'])); ?>

                                    <span class="help-block text-danger"> <?php echo e($errors->first('title')); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="desigName"><?php echo app('translator')->get('english.INFO'); ?></label>
                                    <?php echo e(Form::text('info', Request::get('info'), ['id' => 'info', 'class' => 'form-control', 'placeholder' => 'Enter unit info'])); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(URL::to('/admin/unit')); ?>" class="btn btn-default"><?php echo app('translator')->get('english.CANCEL'); ?></a>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_8\htdocs\test\resources\views/admin/unit/create.blade.php ENDPATH**/ ?>