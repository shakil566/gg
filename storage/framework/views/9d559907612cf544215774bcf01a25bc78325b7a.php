                ...
                <div class="col-md-8 margin-top-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo app('translator')->get('english.UPDATE_USER_GROUP'); ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo e(Form::model($userGroup, array('route' => array('userGroup.update', $userGroup->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'userGroupEditForm'))); ?>


                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo app('translator')->get('english.NAME'); ?></label>
                                <?php echo e(Form::text('name', Request::get('name'), ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Enter userGroup Name'])); ?>

                                <span class="help-block text-danger"> <?php echo e($errors->first('name')); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo app('translator')->get('english.INFO'); ?></label>
                                <?php echo e(Form::text('info', Request::get('info'), ['id' => 'info', 'class' => 'form-control', 'placeholder' => 'Enter userGroup Info'])); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_8\htdocs\test\resources\views/admin/userGroup/edit.blade.php ENDPATH**/ ?>