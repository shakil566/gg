                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-logo">
                            <img class="home-logo" src="{{ asset('public/img') }}/logo.png" alt="Footer Logo">
                            <p class="info">
                                {{-- We are always . --}}
                            </p>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li><a href="{{ url('shop-left-sidebar') }}">New products</a></li>
                                <li><a href="{{ url('shop-left-sidebar') }}">Best sales</a></li>
                                <li><a href="{{ url('shop-left-sidebar') }}">Featured Products</a></li>
                                <li><a href="{{ url('shop-left-sidebar') }}">Brands</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-links">
                        <ul>
                            ...
                            <li><a href="{{ url('shop-left-sidebar') }}">Most Populars</a></li>
                            <li><a href="{{ url('shop-left-sidebar') }}">New Arrivals</a></li>
                            <li><a href="{{ url('shop-left-sidebar') }}">Special Products</a></li>
                    ...
                    <div class="copyright text-center pt-25">
                        <span><a target="_blank" href="#">@lang('english.SHOP_NAME')</a></span>
                    </div>
