    ...
    <ul class="navbar-nav ml-auto">
        ...
        {{-- <li class="nav-item">
            <a class="nav-link" href="#">
                <img src="{{ asset('public/backend') }}/dist/img/user2-160x160.jpg" class="img-circle user-icon"
                alt="User Image">
            </a>
        </li> --}}
        <li class="nav-item dropdown">
            ...
            <a class="nav-link" data-toggle="dropdown" href="#">
                <img src="{{ asset('public') }}/img/unknown.png" class="img-circle user-icon" alt="User Image">
                <span class="nav-username">{{ Auth::user()->first_name .' '. Auth::user()->last_name }} <i
                        class="fas fa-angle-down"></i></span>
            </a>
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">

                <a href="#" class="dropdown-item">
                    <i class="fa fa-user"></i> @lang('english.PROFILE')
                </a>
