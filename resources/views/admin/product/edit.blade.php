                ...
                <div class="row">
                    ...
                    <div class="col-md-8 margin-top-10">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {{ Form::model($target, ['route' => ['product.update', $target->id], 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'productUpdate', 'files' => true,]) }}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', ['1' => __('english.ACTIVE'), '2' => __('english.INACTIVE')], null, [
