                    ...
                    <div class="col-md-8 margin-top-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">@lang('english.UPDATE_PRODUCT_CATEGORY')</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            {{ Form::model($productCategory, ['route' => ['productCategory.update', $productCategory->id], 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'productCategoryUpdate', 'files' => true,]) }}
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!empty($productCategory->photo))
                                        <img width="100" height="100"
                                            src="{{ URL::to('/') }}/public/uploads/productCategory/{{ $productCategory->photo }}"
