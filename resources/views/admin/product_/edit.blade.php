                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4" for="productCatId">@lang('label.BRAND') :<span class="text-danger"> *</span></label>
                                <div class="col-md-8">
...
<!--                                    <div class="clearfix">
                        ...
                        <div class="col-md-6">
                            <!--                            <div class="form-group">
                                                            ...
                                                            {!! Form::hidden('variant_product', !empty($target->variant_product) ? $target->variant_product : '0', ['id' => 'variantProduct']) !!}
                                                        </div>-->
                            @if($target->variant_product == '0')
                            <div class="form-group">
                                <label class="control-label col-md-4" for="skuCode">@lang('label.SKU_CODE') :<span class="text-danger"> *</span></label>
                                <div class="col-md-8">
                                    {!! Form::text('sku_code', !empty($targetSku->sku_code) ? $targetSku->sku_code : null, ['id'=> 'skuCode', 'class' => 'form-control','autocomplete' => 'off', 'placeholder'=> 'ABC-XY-123']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group bootstrap-touchspin">
                                        ...
                                        {!! Form::text('selling_price', !empty($targetSku->selling_price) ? $targetSku->selling_price : null, ['id'=> 'sellingPrice', 'class' => 'form-control integer-decimal-only','autocomplete' => 'off']) !!}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group bootstrap-touchspin">
                                        <span class="input-group-addon bootstrap-touchspin-prefix bold">$</span>
                                        {!! Form::text('purchase_price', !empty($targetSku->purchase_price) ? $targetSku->purchase_price : null, ['id'=> 'purchasePrice', 'class' => 'form-control integer-decimal-only','autocomplete' => 'off']) !!}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('reorder_level', !empty($targetSku->reorder_level) ? $targetSku->reorder_level : null, ['id'=> 'reorderLevel', 'class' => 'form-control integer-only','autocomplete' => 'off']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group bootstrap-touchspin"> 
                                        {!! Form::text('weight', !empty($targetSku->weight) ? $targetSku->weight : null, ['id'=> 'weight', 'class' => 'form-control integer-decimal-only','autocomplete' => 'off']) !!}
