    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@lang('english.DESIGNATION')</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/dashboard/admin') }}">@lang('english.DASHBOARD')</a></li>
                            <li class="breadcrumb-item active">@lang('english.DESIGNATION')</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">@lang('english.DESIGNATION_DETAILS')</h3>
                                        ...
                                        @if (!empty($designationArr))
                                            ...
                                            @foreach ($designationArr as $value)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        {{ Form::open(['url' => 'admin/designation/' . $value->id, 'id' => 'delete']) }}
                                                        {{ Form::hidden('_method', 'DELETE') }}
                                                        <a class='btn btn-primary btn-xs'
                                                            href="{{ URL::to('admin/designation/' . $value->id . '/edit') }}"
