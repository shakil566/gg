                    ...
                    <div class="col-md-8 margin-top-10">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">@lang('english.UPDATE_DEPARTMENT')</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            {{ Form::model($department, array('route' => array('department.update', $department->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'departmentUpdate')) }}
                            ...
                            <div class="card-footer">
                                <a href="{{ URL::to('/admin/department') }}" class="btn btn-default"><i class="fas fa-times"></i> @lang('english.CANCEL')</a>
