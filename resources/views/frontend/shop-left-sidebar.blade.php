                                                    ...
                                                    <div class="single-product-wrap">
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="{{ url('single-product') }}">Accusantium dolorem1</a></h4>
                                                                <div class="price-box">
                                                            ...
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <li class="add-cart active"><a href="{{ url('shopping-cart') }}">Add to cart</a></li>
                                                                    <li><a href="#" title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                                                    <li><a class="links-details" href="{{ url('wishlist') }}"><i class="fa fa-heart-o"></i></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-5 col-md-7">
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="{{ url('single-product') }}">Hummingbird printed t-shirt</a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price">$46.80</span>
                                                                </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="shop-add-action mb-xs-30">
                                                            <ul class="add-actions-link">
                                                                ...
                                                                <li class="wishlist"><a href="{{ url('wishlist') }}"><i class="fa fa-heart-o"></i>Add to wishlist</a></li>
