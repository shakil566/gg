                        ...
                        <div class="single-slide align-center-left  animation-style-01 bg-1">
                            ...
                            <div class="slider-content">
                                ...
                                <div class="default-btn slide-btn">
                                    <a class="links" href="{{ url('shop-left-sidebar') }}">Shopping Now</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        <div class="product-review">
                                            <h5 class="manufacturer">
                                                <a href="{{ url('shop-left-sidebar') }}">Graphic Corner</a>
                                            </h5>
                                        ...
                                        <h4><a class="product_name" href="{{ url('single-product') }}">Accusantium
                                                dolorem1</a></h4>
                                        <div class="price-box">
                                    ...
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            ...
                                            <li><a class="links-details" href="{{ url('wishlist') }}"><i
                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        <div class="product-review">
                                            <h5 class="manufacturer">
                                                <a href="{{ url('shop-left-sidebar') }}">Studio Design</a>
                                            </h5>
                                            <div class="rating-box">
                                                <ul class="rating">
                                                    <li><i class="fa fa-star-o"></i></li>
                                        ...
                                        <h4><a class="product_name" href="{{ url('single-product') }}">Mug Today is a
                                                good day</a></h4>
                                        <div class="price-box">
            ...
            <div class="col-lg-12">
                <div class="li-section-title">
                    ...
                    <ul class="li-sub-category-list">
                        <li class="active"><a href="{{ url('shop-left-sidebar') }}">Prime Video</a></li>
                        <li><a href="{{ url('shop-left-sidebar') }}">Computers</a></li>
                        <li><a href="{{ url('shop-left-sidebar') }}">Electronics</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="product-active owl-carousel">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="li-section-title">
                    ...
                    <ul class="li-sub-category-list">
                        <li class="active"><a href="{{ url('shop-left-sidebar') }}">Chamcham</a></li>
                        <li><a href="{{ url('shop-left-sidebar') }}">Sanai</a></li>
                        <li><a href="{{ url('shop-left-sidebar') }}">Meito</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="product-active owl-carousel">
            ...
            <div class="col-lg-12">
                ...
                <div class="li-static-home-content">
                    ...
                    <div class="default-btn">
                        <a href="{{ url('shop-left-sidebar') }}" class="links">Shopping Now</a>
                    </div>
                </div>
                                        ...
                                        <div class="product_desc">
                                            <div class="product_desc_info">
                                                ...
                                                <h4><a class="product_name"
                                                        href="{{ url('single-product') }}">Accusantium dolorem1</a></h4>
                                                <div class="price-box">
                                                    <span class="new-price">$46.80</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="single-product-wrap">
                                        ...
                                        <div class="product_desc">
                                            <div class="product_desc_info">
                                                ...
                                                <h4><a class="product_name" href="{{ url('single-product') }}">Mug Today
                                                        is a good day</a></h4>
                                                <div class="price-box">
                                                    <span class="new-price new-price-2">$71.80</span>
                                                    <span class="old-price">$77.22</span>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/1.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/2.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/3.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/4.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/5.jpg"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ asset('public/frontend') }}/images/product/small-size/6.jpg"
                                        alt="product image thumb"></div>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                        ...
                        <div class="product-details-view-content pt-60">
                            <div class="product-info">
                                ...
                                <div class="product-additional-info pt-25">
                                    <a class="wishlist-btn" href="{{ url('wishlist') }}"><i
