                ...
                <div class="col-lg-5 col-md-6">
                    ...
                    <div class="product-details-left">
                        ...
                        <div class="product-details-thumbs slider-thumbs-1">
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/1.jpg" alt="product image thumb">
                            </div>
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/2.jpg" alt="product image thumb">
                            </div>
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/3.jpg" alt="product image thumb">
                            </div>
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/4.jpg" alt="product image thumb">
                            </div>
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/5.jpg" alt="product image thumb">
                            </div>
                            <div class="sm-image"><img src="{{ asset('public/') }}/frontend/images/product/small-size/6.jpg" alt="product image thumb">
                            </div>
                        </div>
                    </div>
                    <!--// Product Details Left -->
                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="product-additional-info pt-25">
                                <a class="wishlist-btn" href="{{ url('wishlist') }}"><i class="fa fa-heart-o"></i>Add to
                                    wishlist</a>
            ...
            <div class="tab-content">
                ...
                <div id="product-details" class="tab-pane" role="tabpanel">
                    <div class="product-details-manufacturer">
                        <a href="#">
                            <img src="{{ asset('public/') }}/frontend/images/product-details/1.jpg" alt="Product Manufacturer Image">
                        </a>
                                ...
                                <div class="single-product-wrap">
                                    ...
                                    <div class="product_desc">
                                        <div class="product_desc_info">
                                            ...
                                            <h4><a class="product_name" href="{{ url('single-product') }}">Mug Today is a good
                                                    day</a></h4>
                                            <div class="price-box">
